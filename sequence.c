 ...
 * sequence.c
 *
 * Implementación de diversas funciones para la creación, liberación de la
 * memoria asignada, mezcla y ordenamiento de secuencias, como de la 
 * extracción y escritura de secuencias en un archivo.
 *
